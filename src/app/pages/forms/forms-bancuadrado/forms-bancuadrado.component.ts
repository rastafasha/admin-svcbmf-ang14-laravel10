...
export class FormsBancuadradoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (id) {
      ...
      this.banncuadradoService.getBancuadrado(+id).subscribe((res: any) => {
  ...
  get enlace() {
    return this.cuadradoForm.get('enlace');
  }
  get target() {
    return this.cuadradoForm.get('target');
  }
  get titulo() {
    return this.cuadradoForm.get('titulo');
  }
  get is_active() {
    return this.cuadradoForm.get('is_active');
  }
